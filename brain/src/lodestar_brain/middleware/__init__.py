...
is written where the graph is built, not here. `summarize` touches the model call
instead: what a long conversation is allowed to cost.
...
__all__ = ['BEGIN', 'END', 'PROMPT_RULE', 'UntrustedToolOutput',
           'configure_tracing', 'decode', 'fence', 'make_context_editor',
