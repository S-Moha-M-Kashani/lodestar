...
- **Import with a documented schema**: the Import dialog shows the expected JSON format (copyable), so a valid board file can be written by hand — or generated by an AI
